...
var _AccountService_keyring;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AccountService = exports.SignTypedDataVersion = exports.AccountImportStrategy = exports.KeyringTypes = void 0;
...
class AccountService extends AbstractService_1.AbstractService {
    constructor() {
        super(...arguments);
        this.name = 'AccountService';
        this.mutex = new async_mutex_1.Mutex();
        _AccountService_keyring.set(this, void 0);
    }
    initialize(config, state) {
        __classPrivateFieldSet(this, _AccountService_keyring, new eth_keyring_controller_1.default(Object.assign({ initState: state }, config)), "f");
        this.defaultState = Object.assign(Object.assign({}, __classPrivateFieldGet(this, _AccountService_keyring, "f").store.getState()), { keyrings: [] });
        __classPrivateFieldGet(this, _AccountService_keyring, "f").store.subscribe((s) => {
            this.updateState(s);
        });
        this.fullUpdate();
    }
    ...
    addNewAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            const primaryKeyring = __classPrivateFieldGet(this, _AccountService_keyring, "f").getKeyringsByType('HD Key Tree')[0];
            /* istanbul ignore if */
            if (!primaryKeyring) {
                throw new Error('No HD keyring found');
            }
            const oldAccounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
            yield __classPrivateFieldGet(this, _AccountService_keyring, "f").addNewAccount(primaryKeyring);
            const newAccounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
    ...
    createNewVaultAndKeychain(password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const vault = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").createNewVaultAndKeychain(password);
                this.updateIdentities(yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts());
                this.fullUpdate();
                return vault;
            }
            finally {
    ...
    updateIdentities(addresses) {
        var _a;
        const preferencesService = (_a = this.manager) === null || _a === void 0 ? void 0 : _a.getServiceByName('PreferencesService');
    ...
    createNewVaultAndRestore(password, seed) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const vault = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").createNewVaultAndRestore(password, seed);
                this.updateIdentities(yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts());
                this.fullUpdate();
                return vault;
            }
    ...
    validatePassword(password) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").password === password;
    }
    /**
     ...
     */
    isUnlocked() {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").memStore.getState().isUnlocked;
    }
    /**
    ...
    exportSeedPhrase(password) {
        if (this.validatePassword(password)) {
            return __classPrivateFieldGet(this, _AccountService_keyring, "f").keyrings[0].mnemonic;
        }
        throw new Error('Invalid password');
    }
    /**
    ...
    exportAccount(password, address) {
        if (this.validatePassword(password)) {
            return __classPrivateFieldGet(this, _AccountService_keyring, "f").exportAccount(address);
        }
        throw new Error('Invalid password');
    }
    /**
     ...
     */
    getAccounts() {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
    }
    /**
    ...
    importAccountWithStrategy(strategy, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newKeyring = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").addNewKeyring(KeyringTypes.simple, [privateKey]);
            const accounts = yield newKeyring.getAccounts();
            const allAccounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
    ...
    removeAccount(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield __classPrivateFieldGet(this, _AccountService_keyring, "f").removeAccount(address);
            return this.fullUpdate();
        });
    }
    /**
     ...
     */
    setLocked() {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").setLocked();
    }
    /**
    ...
    signMessage(messageParams) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").signMessage(messageParams);
    }
    /**
    ...
    signPersonalMessage(messageParams) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").signPersonalMessage(messageParams);
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (qrAccounts.findIndex((qrAddress) => qrAddress.toLowerCase() === address.toLowerCase()) !== -1) {
                    ...
                    return __classPrivateFieldGet(this, _AccountService_keyring, "f").signTypedMessage(messageParamsClone, { version });
                }
                const { password } = __classPrivateFieldGet(this, _AccountService_keyring, "f");
    ...
    signTransaction(transaction, from) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").signTransaction(transaction, from);
    }
    /**
    ...
    submitPassword(password) {
        return __awaiter(this, void 0, void 0, function* () {
            yield __classPrivateFieldGet(this, _AccountService_keyring, "f").submitPassword(password);
            const accounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
     ...
     */
    onLock(listener) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").on('lock', listener);
    }
    /**
     ...
     */
    onUnlock(listener) {
        return __classPrivateFieldGet(this, _AccountService_keyring, "f").on('unlock', listener);
    }
    /**
    ...
    verifySeedPhrase() {
        return __awaiter(this, void 0, void 0, function* () {
            const primaryKeyring = __classPrivateFieldGet(this, _AccountService_keyring, "f").getKeyringsByType(KeyringTypes.hd)[0];
            /* istanbul ignore if */
            if (!primaryKeyring) {
                throw new Error('No HD keyring found.');
            }
            ...
            const TestKeyringClass = __classPrivateFieldGet(this, _AccountService_keyring, "f").getKeyringClassForType(KeyringTypes.hd);
    ...
    fullUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            const keyrings = yield Promise.all(__classPrivateFieldGet(this, _AccountService_keyring, "f").keyrings.map((keyring, index) => __awaiter(this, void 0, void 0, function* () {
            ...
            return __classPrivateFieldGet(this, _AccountService_keyring, "f").fullUpdate();
        });
    }
    /**
    ...
    addQRKeyring() {
        return __awaiter(this, void 0, void 0, function* () {
            const keyring = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").addNewKeyring(KeyringTypes.qr);
    ...
    getOrAddQRKeyring() {
        return __awaiter(this, void 0, void 0, function* () {
            const keyring = __classPrivateFieldGet(this, _AccountService_keyring, "f").getKeyringsByType(KeyringTypes.qr)[0];
    ...
    connectQRHardware(page) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return accounts.map((account) => (Object.assign(Object.assign({}, account), { balance: '0x0' })));
            }
            catch (e) {
    ...
    unlockQRHardwareWalletAccount(index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oldAccounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
            yield __classPrivateFieldGet(this, _AccountService_keyring, "f").addNewAccount(keyring);
            const newAccounts = yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getAccounts();
            this.updateIdentities(newAccounts);
            ...
            yield __classPrivateFieldGet(this, _AccountService_keyring, "f").persistAllKeyrings();
            yield this.fullUpdate();
        });
    }
    getAccountKeyringType(account) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield __classPrivateFieldGet(this, _AccountService_keyring, "f").getKeyringForAccount(account)).type;
        });
    }
    forgetQRDevice() {
        return __awaiter(this, void 0, void 0, function* () {
...
_AccountService_keyring = new WeakMap();
