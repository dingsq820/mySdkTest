import { IKeyringState as IQRKeyringState, MetaMaskKeyring as QRKeyring } from '@keystonehq/metamask-airgapped-keyring';
...
export declare class AccountService<A extends AbstractAccountAdapter<AccountState, AccountConfig>> extends AbstractService<A, AccountState, AccountConfig> {
    #private;
    name: string;
    private mutex;
